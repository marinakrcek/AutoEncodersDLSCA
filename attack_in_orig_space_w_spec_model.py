...
if __name__ == "__main__":
    ...
    folder_results = f"{home_folder}/best_ascadf/with_orig"

    """ load hyperparameters """
    optimizers = {"Adam": Adam, 'RMSprop': RMSprop, 'SGD': SGD, 'Adagrad': Adagrad}
    npz_file = np.load(attack_model, allow_pickle=True)
